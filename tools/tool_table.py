...
ORDER = [
    ...
    "oggpair.py", "ogg_rows.py", "compid.py", "objcode.py", "coffreloc.py", "coffwrite.py",
    ...
    "test_privacy_history_guard.py", "test_doc_guards.py",
    "test_verify_honesty.py", "test_match_api.py",
