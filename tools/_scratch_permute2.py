"""SCRATCH COPY of tools/permute.py with its own work directory, so a
second sweep can run while a long one is in the background. Not part of the
build; delete when the session ends.
