...
**1,299 functions matched** — 448 written by hand from the disassembly, 818 generated from their own encodings, 33 upstream libogg/libvorbis — reproducing 50,660 of the 8,467,964 bytes in `.text`, 0.5983%.
...
35 checks. Several are **negative controls**: they corrupt one fact
...
```
124 of 178 runs, 12,100 bytes — placed, ordered and padded by link.exe
```
